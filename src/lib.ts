...
export const encode = (buffer: Uint8Array, width: number, height: number, channels: number) => {
...
export const decode = (buffer: Uint8Array): QOIFile => {
  ...
  const insertColorIntoSeen = (c: Color) => {
